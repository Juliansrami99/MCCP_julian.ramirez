...
run 2019_2_mcpp_taller_3_listas_ejemplos.py
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{run} \PY{l+m+mi}{2019}\PY{n}{\PYZus{}2\PYZus{}mcpp\PYZus{}taller\PYZus{}3\PYZus{}listas\PYZus{}ejemplos}\PY{o}{.}\PY{n}{py}
\end{Verbatim}
...
lista). ¿Cuántos "appends" debe hacer?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}66}]:} \PY{k+kn}{import} \PY{n+nn}{random} \PY{k}{as} \PY{n+nn}{r}
...
listas l0 o l1 al ejecutar los anteriores comandos?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{n1}\PY{o}{=}\PY{n}{l1}\PY{o}{+}\PY{n}{l0}
